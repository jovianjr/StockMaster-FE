					...
					<Box className="flex !py-10">
						...
						<div className="flex flex-1 flex-col gap-1">
							...
							<span className="relative mt-2 flex items-center">
								<Link href="/games">
									<button className="rounded-full border border-white/20 px-6 py-1 text-[0.625rem] text-xs font-semibold text-c-yellow transition-all hover:bg-c-yellow hover:text-black lg:py-2">
										Cek Sekarang
									</button>
								</Link>
								<Image
